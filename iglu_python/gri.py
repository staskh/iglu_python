...
def gri(data: Union[pd.DataFrame, pd.Series], tz: str = "") -> pd.DataFrame:
    ...
    for subject in data['id'].unique():
        ...
        above_180 = above_percent(subject_data, targets_above=[180])['above_180'].iloc[0]
        above_250 = above_percent(subject_data, targets_above=[250])['above_250'].iloc[0]
