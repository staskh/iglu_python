...
def test_gvp_calculation(scenario):
...
def test_gvp_basic():
    ...
    data = pd.DataFrame({
        ...
        'gl': [80, 100, 120, 120, 100, 80]  # Different rates of change for each subject
    })
...
def test_gvp_missing_values():
    ...
    data = pd.DataFrame({
        ...
        'time': pd.to_datetime(['2020-01-01 00:00:00', '2020-01-01 00:05:00', '2020-01-01 00:10:00','2020-01-01 00:15:00','2020-01-01 00:20:00']),
