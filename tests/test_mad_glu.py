...
def test_mad_glu_output_format():
    ...
    assert result_custom['MAD'].iloc[0] != result_default['MAD'].iloc[0]  # Different constants should give different results
    assert result_custom['MAD'].iloc[0] == result_default['MAD'].iloc[0] * (2.0 / 1.4826)  # Check scaling relationship 