...
def test_j_index_calculation(scenario):
...
def test_j_index_basic():
    ...
    assert (abs(result.loc[result['id'] == 'subject1', 'J_index'].iloc[0] - 45.000)/45.000) < 0.1
    assert (abs(result.loc[result['id'] == 'subject2', 'J_index'].iloc[0] - 40.000)/40.000) < 0.1
