...
def get_test_scenarios():
    ...
    try:
        ...
        pytest.skip('expected_results.json could not be loaded, skipping eA1C calculation test')
...
def test_ea1c_calculation(scenario):
...
def test_ea1c_default():
    ...
    assert all((result['eA1C'] >= 0) & (result['eA1C'] <= 20))  # eA1C should be in reasonable range
